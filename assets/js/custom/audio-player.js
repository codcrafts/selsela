...
function simp_changeAudio(elem) {
  ...
  simp_controls.querySelector(".start-time").innerHTML = "0:0";
  simp_controls.querySelector(".end-time").innerHTML = "0:0";
  elem =
...
if (document.querySelector("#simp")) {
  ...
  <div class="row align-items-center">
      <div class="col-md-3">
          <div class="simp-display">
              <div class="simp-album">
                  <div class="simp-cover">
                  </div>
                  <div class="simp-info">
                  <div class="simp-artist">Artist</div>
                  <div class="simp-title">Title</div>
                  </div>
              </div>
          </div>
      </div>
      ...
      <div class="col-md-9">
          <div class="simp-controls flex-wrap flex-align">
              ...
              <div class="simp-volume flex flex-align">
                  <button type="button" class="simp-mute far fa-volume-up"></button>
                  <input class="simp-v-slider d-none" type="range" min="0" max="100" value="100" />
                  <div class="simp-time flex flex-align"><span class="start-time">
                          0:0
                      </span>
                      <span class="simp-slash">&#160;/&#160;</span><span class="end-time">0:0</span>
                  </div>
              </div>

              <div class="simp-tracker simp-load"><input class="simp-progress" type="range" min="0" max="100"
                      value="0" disabled />
              ...
              <div class="simp-plauseward d-flex flex-align">
              <button type="button" class="simp-prev far fa-fast-forward" disabled></button>
              <button type="button" class="simp-plause far fa-play" disabled></button>
              <button type="button" class="simp-next far fa-fast-backward" disabled></button>
              </div>
              
              <div class="simp-others flex flex-align">
                  <button type="button" class="simp-plext far fa-play-circle" title="Auto Play">

                  </button>
                  <button type="button" class="simp-random far fa-random" title="Random"></button>
                  <div class="simp-shide">
                      </button><button type="button" class="simp-shide-bottom far fa-list" data-bs-toggle="tooltip" data-bs-placement="top" title="عرض القائمة"></button>
                  </div>
              </div>
          </div>
      </div>
